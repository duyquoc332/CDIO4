...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="fumo-container">
        <!-- Header với màu xanh -->
        <header class="fumo-header">
            <div class="header-center">
                <div class="logo-container">
                    <asp:Image ID="imgLogo" runat="server" ImageUrl="~/Images/logo.png" Alt="logo" />
                </div>
                
                <div class="search-main">
                    <div class="search-container">
                        <asp:Image ID="imgSearch" runat="server" ImageUrl="~/Images/search.png" CssClass="search-icon" />
                        <asp:TextBox ID="txtSearch" runat="server" CssClass="search-box" placeholder="Tìm kiếm"></asp:TextBox>
                    </div>
                </div>
                
                <div class="header-icons-right">
                    <asp:ImageButton ID="ibPhone" runat="server" ImageUrl="~/Images/phone.png" OnClick="ibPhone_Click" />
                    <asp:ImageButton ID="ibCart" runat="server" ImageUrl="~/Images/cart.png"  OnClick="ibCart_Click" />
                    <asp:Button ID="btnLoginHeader" runat="server" Text="Đăng Nhập" CssClass="login-btn" OnClick="btnLoginHeader_Click" />
                </div>
            </div>
        </header>
        ...
        <!-- Footer với màu xanh -->
        <footer class="fumo-footer">
            <div class="footer-content">
                <p>&copy; 2024 FUMO FOOD. Tất cả các quyền được bảo lưu.</p>
